...
class C0016c {
    ...
    public static class C0015b {
        ...
        C0015b(char c, float[] fArr) {
            this.f47a = c;
            this.f48b = fArr;
        }

        C0015b(C0015b c0015b) {
            this.f47a = c0015b.f47a;
            this.f48b = C0016c.m33a(c0015b.f48b, 0, c0015b.f48b.length);
        }

        private static void m25a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                path.rCubicTo(((float) ((sin2 * d10) + d5)) - ((float) d5), ((float) d16) - ((float) d6), ((float) d17) - ((float) d5), ((float) (d14 - (d10 * cos3))) - ((float) d6), ((float) d13) - ((float) d5), ((float) d14) - ((float) d6));
                i++;
                sin2 = d15;
                d8 = d12;
                d6 = d14;
        ...
        private static void m26a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0015b.m26a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0015b.m25a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m27a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            switch (c2) {
                ...
                case 'v':
                    i = 1;
                    break;
                case C0861R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C0861R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case C0861R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                        C0015b.m26a(path, f10, f9, fArr2[i2 + 5], fArr2[i2 + 6], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
                    ...
                    case C0861R.styleable.AppCompatTheme_colorControlNormal /*86*/:
                        ...
                        break;
                    case C0861R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                        C0015b.m26a(path, f10, f9, fArr2[i2 + 5] + f10, fArr2[i2 + 6] + f9, fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f3 = f10 + fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6] + f9;
                        f6 = f7;
                        f5 = f8;
        ...
        public static void m28a(C0015b[] c0015bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0015bArr.length; i++) {
                C0015b.m27a(path, fArr, c, c0015bArr[i].f47a, c0015bArr[i].f48b);
                c = c0015bArr[i].f47a;
            }
        }
    }

    private static int m29a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m30a(java.lang.String r7, int r8, android.support.p003a.p004a.C0016c.C0014a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f46b = r1;
    ...
    private static void m31a(ArrayList<C0015b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0015b(c, fArr));
    }

    public static boolean m32a(C0015b[] c0015bArr, C0015b[] c0015bArr2) {
        if (c0015bArr == null || c0015bArr2 == null || c0015bArr.length != c0015bArr2.length) {
            return false;
        }
        int i = 0;
        while (i < c0015bArr.length) {
            if (c0015bArr[i].f47a != c0015bArr2[i].f47a || c0015bArr[i].f48b.length != c0015bArr2[i].f48b.length) {
                return false;
            }
            i++;
        }
    ...
    static float[] m33a(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    public static C0015b[] m34a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0016c.m29a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0016c.m31a(arrayList, trim.charAt(0), C0016c.m37b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0016c.m31a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0015b[]) arrayList.toArray(new C0015b[arrayList.size()]);
    }

    public static C0015b[] m35a(C0015b[] c0015bArr) {
        if (c0015bArr == null) {
            return null;
        }
        C0015b[] c0015bArr2 = new C0015b[c0015bArr.length];
        for (int i = 0; i < c0015bArr.length; i++) {
            c0015bArr2[i] = new C0015b(c0015bArr[i]);
        }
        return c0015bArr2;
    }

    public static void m36b(C0015b[] c0015bArr, C0015b[] c0015bArr2) {
        for (int i = 0; i < c0015bArr2.length; i++) {
            c0015bArr[i].f47a = c0015bArr2[i].f47a;
            for (int i2 = 0; i2 < c0015bArr2[i].f48b.length; i2++) {
                c0015bArr[i].f48b[i2] = c0015bArr2[i].f48b[i2];
            }
        }
    }

    private static float[] m37b(String str) {
