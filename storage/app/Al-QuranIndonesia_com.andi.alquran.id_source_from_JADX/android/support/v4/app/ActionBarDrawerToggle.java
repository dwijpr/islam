...
public class ActionBarDrawerToggle implements C0170e {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = aj.m1884g(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = C0173a.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = C0173a.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.m2302g(8388611)) {
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = C0173a.getDrawable(this.mActivity, i);
        }
