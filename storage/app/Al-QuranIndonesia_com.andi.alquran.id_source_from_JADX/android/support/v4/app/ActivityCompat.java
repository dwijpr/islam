...
public class ActivityCompat extends C0173a {

    /* renamed from: android.support.v4.app.ActivityCompat.1 */
    static class C01711 implements Runnable {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ String[] val$permissions;
        final /* synthetic */ int val$requestCode;

        C01711(String[] strArr, Activity activity, int i) {
    ...
    private static class SharedElementCallback23Impl extends SharedElementCallback23 {
        ...
        class C01721 implements OnSharedElementsReadyListener {
            final /* synthetic */ OnSharedElementsReadyListenerBridge val$listener;

            C01721(OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
            this.mCallback.onSharedElementsArrived(list, list2, new C01721(onSharedElementsReadyListenerBridge));
        }
    }
    ...
    public static void requestPermissions(Activity activity, String[] strArr, int i) {
        if (VERSION.SDK_INT >= 23) {
            ...
            new Handler(Looper.getMainLooper()).post(new C01711(strArr, activity, i));
        }
    }
