...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity activity, C0309h<View, String>... c0309hArr) {
        String[] strArr = null;
        ...
        View[] viewArr;
        if (c0309hArr != null) {
            View[] viewArr2 = new View[c0309hArr.length];
            String[] strArr2 = new String[c0309hArr.length];
            for (int i = 0; i < c0309hArr.length; i++) {
                viewArr2[i] = (View) c0309hArr[i].f653a;
                strArr2[i] = (String) c0309hArr[i].f654b;
            }
            strArr = strArr2;
            viewArr = viewArr2;
        } else {
