...
class BundleCompatGingerbread {
    ...
    L_0x0024:
        r0 = sGetIBinderMethod;	 Catch:{ InvocationTargetException -> 0x004a, IllegalAccessException -> 0x003c, IllegalArgumentException -> 0x0048 }
        r2 = 1;
        r2 = new java.lang.Object[r2];	 Catch:{ InvocationTargetException -> 0x004a, IllegalAccessException -> 0x003c, IllegalArgumentException -> 0x0048 }
        r3 = 0;
        r2[r3] = r8;	 Catch:{ InvocationTargetException -> 0x004a, IllegalAccessException -> 0x003c, IllegalArgumentException -> 0x0048 }
        r0 = r0.invoke(r7, r2);	 Catch:{ InvocationTargetException -> 0x004a, IllegalAccessException -> 0x003c, IllegalArgumentException -> 0x0048 }
        r0 = (android.os.IBinder) r0;	 Catch:{ InvocationTargetException -> 0x004a, IllegalAccessException -> 0x003c, IllegalArgumentException -> 0x0048 }
    L_0x0032:
        return r0;
    L_0x0033:
        r0 = move-exception;
        r2 = "BundleCompatGingerbread";
    ...
    L_0x0028:
        r0 = sPutIBinderMethod;	 Catch:{ InvocationTargetException -> 0x004e, IllegalAccessException -> 0x0040, IllegalArgumentException -> 0x004c }
        r1 = 2;
        r1 = new java.lang.Object[r1];	 Catch:{ InvocationTargetException -> 0x004e, IllegalAccessException -> 0x0040, IllegalArgumentException -> 0x004c }
        r2 = 0;
        r1[r2] = r7;	 Catch:{ InvocationTargetException -> 0x004e, IllegalAccessException -> 0x0040, IllegalArgumentException -> 0x004c }
        r2 = 1;
        r1[r2] = r8;	 Catch:{ InvocationTargetException -> 0x004e, IllegalAccessException -> 0x0040, IllegalArgumentException -> 0x004c }
        r0.invoke(r6, r1);	 Catch:{ InvocationTargetException -> 0x004e, IllegalAccessException -> 0x0040, IllegalArgumentException -> 0x004c }
    L_0x0036:
        return;
    L_0x0037:
        r0 = move-exception;
