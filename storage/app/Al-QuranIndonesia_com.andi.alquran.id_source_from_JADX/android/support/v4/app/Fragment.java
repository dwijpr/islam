...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    private static final C0297j<String, Class<?>> sClassMap;
    boolean mAdded;
    ...
    class C01772 extends FragmentContainer {
        C01772() {
        }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C01781 implements Creator<SavedState> {
            C01781() {
            }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        C0511j.m2173a(onGetLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
    ...
    int getNextAnim() {
        return this.mAnimationInfo == null ? INITIALIZING : this.mAnimationInfo.mNextAnim;
    }

    int getNextTransition() {
        return this.mAnimationInfo == null ? INITIALIZING : this.mAnimationInfo.mNextTransition;
    }

    int getNextTransitionStyle() {
        return this.mAnimationInfo == null ? INITIALIZING : this.mAnimationInfo.mNextTransitionStyle;
    }
    ...
    int getStateAfterAnimating() {
        return this.mAnimationInfo == null ? INITIALIZING : this.mAnimationInfo.mStateAfterAnimating;
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C01772(), this);
    }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01761());
        } else {
