...
public class FragmentController {
    ...
    public void restoreLoaderNonConfig(C0297j<String, LoaderManager> c0297j) {
        this.mHost.restoreLoaderNonConfig(c0297j);
    }

    public C0297j<String, LoaderManager> retainLoaderNonConfig() {
