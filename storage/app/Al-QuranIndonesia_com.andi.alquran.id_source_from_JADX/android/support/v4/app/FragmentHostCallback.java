...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    private C0297j<String, LoaderManager> mAllLoaderManagers;
    ...
    LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new C0297j();
        }
    ...
    void reportLoaderStart() {
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                loaderManagerImplArr[i] = (LoaderManagerImpl) this.mAllLoaderManagers.m1003c(i);
            }
    ...
    void restoreLoaderNonConfig(C0297j<String, LoaderManager> c0297j) {
        this.mAllLoaderManagers = c0297j;
    }

    C0297j<String, LoaderManager> retainLoaderNonConfig() {
        int i;
        int i2 = 0;
        if (this.mAllLoaderManagers != null) {
            int size = this.mAllLoaderManagers.size();
            ...
            for (int i3 = size - 1; i3 >= 0; i3--) {
                loaderManagerImplArr[i3] = (LoaderManagerImpl) this.mAllLoaderManagers.m1003c(i3);
            }
