...
import android.support.v4.p014g.C0301d;
import android.support.v4.p014g.C0309h;
...
final class FragmentManagerImpl extends FragmentManager implements C0183n {
    ...
    private CopyOnWriteArrayList<C0309h<FragmentLifecycleCallbacks, Boolean>> mLifecycleCallbacks;
    ...
    static class AnimateOnHWLayerIfNeededListener implements AnimationListener {
        ...
        class C01821 implements Runnable {
            ...
            public void run() {
                aj.m1857a(AnimateOnHWLayerIfNeededListener.this.mView, 0, null);
            }
        }
        ...
        public void onAnimationEnd(Animation animation) {
            if (this.mView != null && this.mShouldRunOnHWLayer) {
                if (aj.m1848E(this.mView) || C0265c.m909a()) {
                    this.mView.post(new C01821());
                } else {
                    aj.m1857a(this.mView, 0, null);
                }
            }
    ...
    class C01812 extends AnimateOnHWLayerIfNeededListener {
        final /* synthetic */ Fragment val$fragment;

        C01812(View view, Animation animation, Fragment fragment) {
    ...
    static class StartEnterTransitionListener implements OnStartEnterTransitionListener {
        ...
        public void completeTransaction() {
            ...
            boolean z2 = this.mNumPostponed > 0 ? true : FragmentManagerImpl.HONEYCOMB;
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        while (i3 < i2) {
            ...
            boolean z3 = (z2 || backStackRecord.mAddToBackStack) ? true : HONEYCOMB;
    ...
    private void setHWLayerAnimListenerIfAlpha(View view, Animation animation) {
        if (view != null && animation != null && shouldRunOnHWLayer(view, animation)) {
            ...
            aj.m1857a(view, (int) ANIM_STYLE_OPEN_EXIT, null);
    ...
    static boolean shouldRunOnHWLayer(View view, Animation animation) {
        return (VERSION.SDK_INT >= 19 && aj.m1883f(view) == 0 && aj.m1901x(view) && modifiesAlpha(animation)) ? true : HONEYCOMB;
    }

    private void throwException(RuntimeException runtimeException) {
        Log.e(TAG, runtimeException.getMessage());
        Log.e(TAG, "Activity state:");
        PrintWriter printWriter = new PrintWriter(new C0301d(TAG));
        if (this.mHost != null) {
            try {
    ...
    void dispatchOnFragmentActivityCreated(Fragment fragment, Bundle bundle, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                ...
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentActivityCreated(this, fragment, bundle);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentAttached(Fragment fragment, Context context, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentAttached(this, fragment, context);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentCreated(Fragment fragment, Bundle bundle, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentCreated(this, fragment, bundle);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentDestroyed(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentDestroyed(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentDetached(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentDetached(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentPaused(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentPaused(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentPreAttached(Fragment fragment, Context context, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentPreAttached(this, fragment, context);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentResumed(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentResumed(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentSaveInstanceState(Fragment fragment, Bundle bundle, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentSaveInstanceState(this, fragment, bundle);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentStarted(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentStarted(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentStopped(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentStopped(this, fragment);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentViewCreated(Fragment fragment, View view, Bundle bundle, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentViewCreated(this, fragment, view, bundle);
                }
            }
        }
    }
    ...
    void dispatchOnFragmentViewDestroyed(Fragment fragment, boolean z) {
        ...
        if (this.mLifecycleCallbacks != null) {
            ...
            while (it.hasNext()) {
                C0309h c0309h = (C0309h) it.next();
                if (!z || ((Boolean) c0309h.f654b).booleanValue()) {
                    ((FragmentLifecycleCallbacks) c0309h.f653a).onFragmentViewDestroyed(this, fragment);
                }
            }
        }
    }
...
*/
    ...
    C0183n getLayoutInflaterFactory() {
        return this;
    }
    ...
    void moveFragmentToExpectedState(Fragment fragment) {
        if (fragment != null) {
            ...
            if (fragment.mRemoving) {
                i = fragment.isInBackStack() ? Math.min(i, ANIM_STYLE_OPEN_ENTER) : Math.min(i, 0);
            }
    ...
    L_0x017b:
        r0 = r11.mView;
        android.support.v4.view.aj.m1871b(r0, r3);
    L_0x0180:
        r0 = r11.mHidden;
    ...
    L_0x01f5:
        r1 = r11.getResources();	 Catch:{ NotFoundException -> 0x0301 }
        r2 = r11.mContainerId;	 Catch:{ NotFoundException -> 0x0301 }
        r1 = r1.getResourceName(r2);	 Catch:{ NotFoundException -> 0x0301 }
    L_0x01ff:
    ...
    L_0x0252:
        r1 = r11.mView;
        android.support.v4.view.aj.m1871b(r1, r3);
    L_0x0257:
    ...
    L_0x0290:
        r0 = 2;
        if (r12 <= r0) goto L_0x0295;
    L_0x0293:
        r11.mState = r6;
    L_0x0295:
        if (r12 <= r6) goto L_0x02b9;
    L_0x0297:
        r0 = DEBUG;
    ...
    public void registerFragmentLifecycleCallbacks(FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z) {
        ...
        this.mLifecycleCallbacks.add(new C0309h(fragmentLifecycleCallbacks, Boolean.valueOf(z)));
    }
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                if (fragmentManagerNonConfig != null) {
                    ...
                    size = fragments != null ? fragments.size() : HONEYCOMB;
                    for (i = 0; i < size; i += ANIM_STYLE_OPEN_ENTER) {
                ...
                if (fragmentManagerNonConfig != null) {
                    fragments = fragmentManagerNonConfig.getFragments();
                    i2 = fragments != null ? fragments.size() : HONEYCOMB;
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (int i3 = 0; i3 < fragmentManagerState.mBackStack.length; i3 += ANIM_STYLE_OPEN_ENTER) {
                        ...
                        if (DEBUG) {
                            ...
                            instantiate.dump("  ", new PrintWriter(new C0301d(TAG)), HONEYCOMB);
                        }
    ...
    public String toString() {
        ...
        if (this.mParent != null) {
            C0300c.m1013a(this.mParent, stringBuilder);
        } else {
    ...
    public void unregisterFragmentLifecycleCallbacks(FragmentLifecycleCallbacks fragmentLifecycleCallbacks) {
        if (this.mLifecycleCallbacks != null) {
            synchronized (this.mLifecycleCallbacks) {
                ...
                for (int i = 0; i < size; i += ANIM_STYLE_OPEN_ENTER) {
                    if (((C0309h) this.mLifecycleCallbacks.get(i)).f653a == fragmentLifecycleCallbacks) {
