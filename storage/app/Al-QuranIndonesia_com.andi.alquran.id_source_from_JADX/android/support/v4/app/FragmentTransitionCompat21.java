...
class FragmentTransitionCompat21 {
    ...
    static class C01911 extends EpicenterCallback {
    ...
    static class C01922 implements TransitionListener {
        final /* synthetic */ ArrayList val$exitingViews;
        final /* synthetic */ View val$fragmentView;

        C01922(View view, ArrayList arrayList) {
    ...
    static class C01933 implements OnPreDrawListener {
        ...
        C01933(View view, int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
    ...
    static class C01944 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C01944(View view, ArrayList arrayList, Map map) {
            this.val$sceneRoot = view;
            this.val$sharedElementsIn = arrayList;
    ...
    static class C01955 implements TransitionListener {
        ...
        C01955(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
    ...
    static class C01966 extends EpicenterCallback {
        final /* synthetic */ Rect val$epicenter;
        ...
        public Rect onGetEpicenter(Transition transition) {
            return (this.val$epicenter == null || this.val$epicenter.isEmpty()) ? null : this.val$epicenter;
        }
    }

    /* renamed from: android.support.v4.app.FragmentTransitionCompat21.7 */
    static class C01977 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ ViewGroup val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C01977(ViewGroup viewGroup, ArrayList arrayList, Map map) {
    ...
    public static void scheduleHideFragmentView(Object obj, View view, ArrayList<View> arrayList) {
        ((Transition) obj).addListener(new C01922(view, arrayList));
    }

    public static void scheduleNameReset(ViewGroup viewGroup, ArrayList<View> arrayList, Map<String, String> map) {
        viewGroup.getViewTreeObserver().addOnPreDrawListener(new C01977(viewGroup, arrayList, map));
    }
    ...
    public static void scheduleRemoveTargets(Object obj, Object obj2, ArrayList<View> arrayList, Object obj3, ArrayList<View> arrayList2, Object obj4, ArrayList<View> arrayList3) {
        ((Transition) obj).addListener(new C01955(obj2, arrayList, obj3, arrayList2, obj4, arrayList3));
    }

    public static void setEpicenter(Object obj, Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new C01966(rect));
        }
    }
    ...
    public static void setEpicenter(Object obj, View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback(new C01911(rect));
        }
    }
    ...
    public static void setNameOverridesOptimized(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new C01933(view, size, arrayList2, arrayList3, arrayList, arrayList4));
    }

    public static void setNameOverridesUnoptimized(View view, ArrayList<View> arrayList, Map<String, String> map) {
        view.getViewTreeObserver().addOnPreDrawListener(new C01944(view, arrayList, map));
    }
