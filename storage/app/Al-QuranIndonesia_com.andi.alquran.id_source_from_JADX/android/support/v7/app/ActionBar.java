...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = ActionBar.NAVIGATION_MODE_STANDARD;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0627R.styleable.ActionBarLayout_android_layout_gravity, ActionBar.NAVIGATION_MODE_STANDARD);
