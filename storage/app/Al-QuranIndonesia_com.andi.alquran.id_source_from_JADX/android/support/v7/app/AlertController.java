...
import android.support.v4.widget.NestedScrollView.C0547b;
...
class AlertController {
    ...
    class C06033 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C06033(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C06044 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C06044(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C06061 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ RecycleListView val$listView;

            C06061(Context context, int i, int i2, CharSequence[] charSequenceArr, RecycleListView recycleListView) {
        ...
        class C06072 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C06072(Context context, Cursor cursor, boolean z, RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
        ...
        class C06083 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C06083(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C06094 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C06094(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                simpleCursorAdapter = new C06061(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems, recycleListView);
            } else {
                Object c06072 = new C06072(this.mContext, this.mCursor, false, recycleListView, alertController);
            }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new C06083(alertController));
            } else if (this.mOnCheckboxClickListener != null) {
                recycleListView.setOnItemClickListener(new C06094(recycleListView, alertController));
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0627R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0627R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        this.mButtonHandler = new C06011();
        this.mContext = context;
        this.mDialog = appCompatDialog;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(appCompatDialog);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0627R.styleable.AlertDialog, C0627R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0627R.styleable.AlertDialog_showTitle, true);
    ...
    static void manageScrollIndicators(View view, View view2, View view3) {
        int i = 0;
        if (view2 != null) {
            view2.setVisibility(aj.m1873b(view, -1) ? 0 : 4);
        }
        if (view3 != null) {
            if (!aj.m1873b(view, 1)) {
                i = 4;
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2 = null;
        View findViewById = this.mWindow.findViewById(C0627R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0627R.id.scrollIndicatorDown);
        ...
        if (findViewById != null || view2 != null) {
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C06022(findViewById, view2));
                this.mScrollView.post(new C06033(findViewById, view2));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C06044(findViewById, view2));
                this.mListView.post(new C06055(findViewById, view2));
            } else {
                if (findViewById != null) {
                    viewGroup.removeView(findViewById);
                }
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0627R.id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0627R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0627R.id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0627R.id.alertTitle);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0627R.id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0627R.id.topPanel);
        View findViewById3 = findViewById.findViewById(C0627R.id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0627R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0627R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0627R.id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0627R.id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0627R.id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null)) {
            findViewById = resolvePanel2.findViewById(C0627R.id.textSpacerNoButtons);
            if (findViewById != null) {
        ...
        if (z2) {
            ...
            if (!((this.mMessage == null && this.mListView == null && !z) || z)) {
                findViewById = resolvePanel.findViewById(C0627R.id.titleDividerNoCustom);
            }
            if (findViewById != null) {
                findViewById.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            findViewById = resolvePanel2.findViewById(C0627R.id.textSpacerNoTitle);
            if (findViewById != null) {
                findViewById.setVisibility(0);
            }
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0627R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        return this.mScrollView != null && this.mScrollView.m2333a(keyEvent);
    }
