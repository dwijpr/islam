...
class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements OnClickListener {
        ...
        private void resolveMethod(Context context, String str) {
            ...
            throw new IllegalStateException("Could not find method " + this.mMethodName + "(View) in a parent or ancestor Context for android:onClick " + "attribute defined on view " + this.mHostView.getClass() + (id == -1 ? BuildConfig.VERSION_NAME : " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(id) + "'"));
        }
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || aj.m1849F(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0627R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(C0627R.styleable.View_theme, 0);
            if (resourceId != 0) {
