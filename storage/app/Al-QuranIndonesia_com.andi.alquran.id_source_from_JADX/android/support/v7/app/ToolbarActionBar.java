...
class ToolbarActionBar extends ActionBar {
    ...
    class C06232 implements OnMenuItemClickListener {
        C06232() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(C0861R.styleable.AppCompatTheme_ratingBarStyle, menuBuilder);
                }
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(C0861R.styleable.AppCompatTheme_ratingBarStyle, menuBuilder);
            return true;
        }
    }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Callback callback) {
        ...
        this.mMenuInvalidator = new C06221();
        this.mMenuClicker = new C06232();
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(contextThemeWrapper, C0627R.layout.abc_list_menu_item_layout);
    ...
    public float getElevation() {
        return aj.m1895r(this.mDecorToolbar.getViewGroup());
    }
    ...
    public boolean invalidateOptionsMenu() {
        ...
        aj.m1864a(this.mDecorToolbar.getViewGroup(), this.mMenuInvalidator);
        return true;
    }
    ...
    public void setElevation(float f) {
        aj.m1879d(this.mDecorToolbar.getViewGroup(), f);
    }
