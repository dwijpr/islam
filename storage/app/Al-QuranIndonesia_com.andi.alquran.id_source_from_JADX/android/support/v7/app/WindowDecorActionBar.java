...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final bc mShowListener;
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs;
    private Context mThemedContext;
    final be mUpdateListener;

    /* renamed from: android.support.v7.app.WindowDecorActionBar.1 */
    class C06241 extends bd {
        C06241() {
        }

        public void onAnimationEnd(View view) {
            if (WindowDecorActionBar.this.mContentAnimations && WindowDecorActionBar.this.mContentView != null) {
                aj.m1870b(WindowDecorActionBar.this.mContentView, 0.0f);
                aj.m1870b(WindowDecorActionBar.this.mContainerView, 0.0f);
            }
            ...
            if (WindowDecorActionBar.this.mOverlayLayout != null) {
                aj.m1898u(WindowDecorActionBar.this.mOverlayLayout);
            }
        }
    }

    /* renamed from: android.support.v7.app.WindowDecorActionBar.2 */
    class C06252 extends bd {
        C06252() {
        }
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
            return this.mCallback != null ? this.mCallback.onActionItemClicked(this, menuItem) : WindowDecorActionBar.ALLOW_SHOW_HIDE_ANIMATIONS;
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean z) {
        ...
        this.mHideListener = new C06241();
        this.mShowListener = new C06252();
        this.mUpdateListener = new C06263();
    ...
    static boolean checkShowingFlags(boolean z, boolean z2, boolean z3) {
        return z3 ? true : (z || z2) ? ALLOW_SHOW_HIDE_ANIMATIONS : true;
    }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0627R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0627R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0627R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0627R.id.action_bar_container);
        ...
        z = (actionBarPolicy.enableHomeButtonByDefault() || z) ? true : ALLOW_SHOW_HIDE_ANIMATIONS;
        ...
        if (obtainStyledAttributes.getBoolean(C0627R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.ActionBar_elevation, 0);
    ...
    private void setHasEmbeddedTabs(boolean z) {
        ...
        boolean z4 = (this.mHasEmbeddedTabs || !z3) ? ALLOW_SHOW_HIDE_ANIMATIONS : true;
    ...
    private boolean shouldAnimateContextView() {
        return aj.m1846C(this.mContainerView);
    }
    ...
    public void animateToMode(boolean z) {
        ...
        if (shouldAnimateContextView()) {
            ...
            ay ayVar2;
            if (z) {
                ayVar = this.mDecorToolbar.setupAnimatorToVisibility(4, FADE_OUT_DURATION_MS);
                ayVar2 = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
            } else {
                ayVar2 = this.mDecorToolbar.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
                ayVar = this.mContextView.setupAnimatorToVisibility(8, FADE_OUT_DURATION_MS);
            }
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
            viewPropertyAnimatorCompatSet.playSequentially(ayVar, ayVar2);
    ...
    public void doHide(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || z)) {
            aj.m1875c(this.mContainerView, 1.0f);
            ...
            ay c = aj.m1894q(this.mContainerView).m2069c(f);
            c.m2064a(this.mUpdateListener);
            viewPropertyAnimatorCompatSet.play(c);
            if (this.mContentAnimations && this.mContentView != null) {
                viewPropertyAnimatorCompatSet.play(aj.m1894q(this.mContentView).m2069c(f));
            }
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || z)) {
            aj.m1870b(this.mContainerView, 0.0f);
            float f = (float) (-this.mContainerView.getHeight());
            if (z) {
                int[] iArr = new int[]{0, 0};
                this.mContainerView.getLocationInWindow(iArr);
            ...
            aj.m1870b(this.mContainerView, f);
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
            ay c = aj.m1894q(this.mContainerView).m2069c(0.0f);
            c.m2064a(this.mUpdateListener);
            viewPropertyAnimatorCompatSet.play(c);
            if (this.mContentAnimations && this.mContentView != null) {
                aj.m1870b(this.mContentView, f);
                viewPropertyAnimatorCompatSet.play(aj.m1894q(this.mContentView).m2069c(0.0f));
            }
            ...
            aj.m1870b(this.mContainerView, 0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
                aj.m1870b(this.mContentView, 0.0f);
            }
    ...
    public float getElevation() {
        return aj.m1895r(this.mContainerView);
    }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0627R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public void setElevation(float f) {
        aj.m1879d(this.mContainerView, f);
    }
    ...
    public void setNavigationMode(int i) {
        ...
        DecorToolbar decorToolbar = this.mDecorToolbar;
        boolean z2 = (i != 2 || this.mHasEmbeddedTabs) ? ALLOW_SHOW_HIDE_ANIMATIONS : true;
