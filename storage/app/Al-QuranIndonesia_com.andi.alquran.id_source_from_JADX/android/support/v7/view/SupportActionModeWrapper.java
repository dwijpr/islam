...
public class SupportActionModeWrapper extends ActionMode {
    ...
    public static class CallbackWrapper implements Callback {
        ...
        private Menu getMenuWrapper(Menu menu) {
            ...
            menu2 = MenuWrapperFactory.wrapSupportMenu(this.mContext, (C0260a) menu);
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.mWrappedCallback.onActionItemClicked(getActionModeWrapper(actionMode), MenuWrapperFactory.wrapSupportMenuItem(this.mContext, (C0261b) menuItem));
        }
    ...
    public Menu getMenu() {
        return MenuWrapperFactory.wrapSupportMenu(this.mContext, (C0260a) this.mWrappedObject.getMenu());
    }
