...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener, OnLongClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return b >= 480 || ((b >= 640 && C0209a.m740a(getResources()) >= 480) || configuration.orientation == 2);
    }
