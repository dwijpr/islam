...
public class ActionBarOverlayLayout extends ViewGroup implements C0066x, DecorContentParent {
    ...
    ay mCurrentActionBarTopAnimator;
    private DecorToolbar mDecorToolbar;
    private C0588u mFlingEstimator;
    ...
    private final C0537y mParentHelper;
    private final Runnable mRemoveActionBarHideOffset;
    final bc mTopAnimatorListener;
    ...
    class C06472 implements Runnable {
        C06472() {
        }

        public void run() {
            ActionBarOverlayLayout.this.haltActionBarHideOffsetAnimations();
            ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = aj.m1894q(ActionBarOverlayLayout.this.mActionBarTop).m2069c(0.0f).m2063a(ActionBarOverlayLayout.this.mTopAnimatorListener);
        }
    }

    /* renamed from: android.support.v7.widget.ActionBarOverlayLayout.3 */
    class C06483 implements Runnable {
        C06483() {
        }

        public void run() {
            ActionBarOverlayLayout.this.haltActionBarHideOffsetAnimations();
            ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = aj.m1894q(ActionBarOverlayLayout.this.mActionBarTop).m2069c((float) (-ActionBarOverlayLayout.this.mActionBarTop.getHeight())).m2063a(ActionBarOverlayLayout.this.mTopAnimatorListener);
        }
    }
    ...
    static {
        ATTRS = new int[]{C0627R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C06461();
        this.mRemoveActionBarHideOffset = new C06472();
        this.mAddActionBarHideOffset = new C06483();
        init(context);
        this.mParentHelper = new C0537y(this);
    }
    ...
    private void init(Context context) {
        ...
        this.mFlingEstimator = C0588u.m2512a(context);
    }
    ...
    private boolean shouldHideActionBarOnFling(float f, float f2) {
        this.mFlingEstimator.m2516a(0, 0, 0, (int) f2, 0, 0, RtlSpacingHelper.UNDEFINED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        return this.mFlingEstimator.m2523e() > this.mActionBarTop.getHeight();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            int bottom = this.mActionBarTop.getVisibility() == 0 ? (int) ((((float) this.mActionBarTop.getBottom()) + aj.m1890m(this.mActionBarTop)) + 0.5f) : 0;
    ...
    protected boolean fitSystemWindows(Rect rect) {
        boolean applyInsets;
        pullChildren();
        if ((aj.m1897t(this) & NotificationCompat.FLAG_LOCAL_ONLY) != 0) {
    ...
    public int getActionBarHideOffset() {
        return this.mActionBarTop != null ? -((int) aj.m1890m(this.mActionBarTop)) : 0;
    }

    public int getNestedScrollAxes() {
        return this.mParentHelper.m2238a();
    }
    ...
    void haltActionBarHideOffsetAnimations() {
        ...
        if (this.mCurrentActionBarTopAnimator != null) {
            this.mCurrentActionBarTopAnimator.m2068b();
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int combineMeasuredStates = ViewUtils.combineMeasuredStates(0, aj.m1886i(this.mActionBarTop));
        Object obj = (aj.m1897t(this) & NotificationCompat.FLAG_LOCAL_ONLY) != 0 ? 1 : null;
        if (obj != null) {
        ...
        int combineMeasuredStates2 = ViewUtils.combineMeasuredStates(combineMeasuredStates, aj.m1886i(this.mContent));
        setMeasuredDimension(aj.m1852a(Math.max(max3 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, combineMeasuredStates2), aj.m1852a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, combineMeasuredStates2 << 16));
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i) {
        this.mParentHelper.m2240a(view, view2, i);
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        if ((i2 & NotificationCompat.FLAG_LOCAL_ONLY) != 0 && this.mActionBarVisibilityCallback != null) {
            aj.m1898u(this);
        }
    }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0627R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0627R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0627R.id.action_bar));
        }
    }
    ...
    public void setActionBarHideOffset(int i) {
        haltActionBarHideOffsetAnimations();
        aj.m1870b(this.mActionBarTop, (float) (-Math.max(0, Math.min(i, this.mActionBarTop.getHeight()))));
    }
