...
import android.support.v4.view.C0491d.C0489a;
...
class ActionMenuPresenter extends BaseMenuPresenter implements C0489a {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0627R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        class C06491 extends ForwardingListener {
            ...
            C06491(View view, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0627R.attr.actionOverflowButtonStyle);
            this.mTempPts = new float[2];
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C06491(this, ActionMenuPresenter.this));
        }
        ...
        protected boolean setFrame(int i, int i2, int i3, int i4) {
            ...
            if (!(drawable == null || background == null)) {
                ...
                C0242a.m850a(background, width - max, height - max, width + max, height + max);
            }
            return frame;
        }
    }
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0627R.attr.actionOverflowMenuStyle);
            setGravity(8388613);
            setPresenterCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }
    ...
    private static class SavedState implements Parcelable {
        ...
        static class C06501 implements Creator<SavedState> {
            C06501() {
            }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0627R.layout.abc_action_menu_layout, C0627R.layout.abc_action_menu_item_layout);
    ...
    public void updateMenuView(boolean z) {
        ...
        if (this.mMenu != null) {
            ...
            for (i = 0; i < size; i++) {
                C0491d supportActionProvider = ((MenuItemImpl) actionItems.get(i)).getSupportActionProvider();
