...
class AdapterHelper implements Callback {
    ...
    private C0310a<UpdateOp> mUpdateOpPool;
    ...
    static class UpdateOp {
        ...
        public boolean equals(Object obj) {
            ...
            return this.cmd != updateOp.cmd ? AdapterHelper.DEBUG : (this.cmd == MOVE && Math.abs(this.itemCount - this.positionStart) == ADD && this.itemCount == updateOp.positionStart && this.positionStart == updateOp.itemCount) ? true : this.itemCount != updateOp.itemCount ? AdapterHelper.DEBUG : this.positionStart != updateOp.positionStart ? AdapterHelper.DEBUG : this.payload != null ? !this.payload.equals(updateOp.payload) ? AdapterHelper.DEBUG : true : updateOp.payload != null ? AdapterHelper.DEBUG : true;
        }
    ...
    AdapterHelper(Callback callback, boolean z) {
        this.mUpdateOpPool = new C0311b(30);
    ...
    public UpdateOp obtainUpdateOp(int i, int i2, int i3, Object obj) {
        UpdateOp updateOp = (UpdateOp) this.mUpdateOpPool.m1029a();
        if (updateOp == null) {
    ...
    public void recycleUpdateOp(UpdateOp updateOp) {
        if (!this.mDisableRecycler) {
            ...
            this.mUpdateOpPool.m1030a(updateOp);
        }
    }
