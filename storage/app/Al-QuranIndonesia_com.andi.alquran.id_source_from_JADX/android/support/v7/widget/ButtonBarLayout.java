...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        boolean z = C0209a.m740a(getResources()) >= ALLOW_STACKING_MIN_HEIGHT_DP;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.ButtonBarLayout);
        this.mAllowStacking = obtainStyledAttributes.getBoolean(C0627R.styleable.ButtonBarLayout_allowStacking, z);
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0627R.id.spacer);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mAllowStacking && !isStacked()) {
            ...
            if (VERSION.SDK_INT >= 11) {
                z2 = (aj.m1885h(this) & -16777216) == 16777216;
            } else {
                int i4 = 0;
