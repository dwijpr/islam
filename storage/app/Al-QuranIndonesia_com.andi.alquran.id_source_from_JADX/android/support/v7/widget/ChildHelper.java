...
class ChildHelper {
    ...
    static class Bucket {
        ...
        int countOnesBefore(int i) {
            return this.next == null ? i >= BITS_PER_WORD ? Long.bitCount(this.mData) : Long.bitCount(this.mData & ((1 << i) - 1)) : i < BITS_PER_WORD ? Long.bitCount(this.mData & ((1 << i) - 1)) : this.next.countOnesBefore(i - 64) + Long.bitCount(this.mData);
        }
