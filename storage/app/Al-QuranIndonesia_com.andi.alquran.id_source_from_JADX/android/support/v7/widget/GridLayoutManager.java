...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void collectPrefetchPositionsForLayoutState(State state, LayoutState layoutState, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i2 = 0; i2 < this.mSpanCount && layoutState.hasMore(state) && i > 0; i2++) {
            ...
            layoutPrefetchRegistry.addPosition(i3, layoutState.mScrollingOffset);
    ...
    public View onFocusSearchFailed(View view, int i, Recycler recycler, State state) {
        ...
        if (((convertFocusDirectionToLayoutDirection(i) == 1 ? true : DEBUG) != this.mShouldReverseLayout ? 1 : null) != null) {
            ...
            i4 = DEFAULT_SPAN_COUNT;
            i5 = DEFAULT_SPAN_COUNT;
        } else {
            childCount = 0;
            i4 = 1;
            i5 = getChildCount();
        ...
        while (i8 != i5) {
            ...
            if (childAt.isFocusable()) {
                ...
                if (obj2 != null) {
                    ...
                    childCount = Math.min(i10, i3) - Math.max(i9, i2);
                    view3 = childAt;
                } else {
                    childCount = i7;
                    i7 = i6;
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0404c c0404c) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                c0404c.m1511b(C0403m.m1500a(spanIndex, spanSize, spanGroupIndex, 1, z, DEBUG));
                return;
            }
            ...
            c0404c.m1511b(C0403m.m1500a(spanGroupIndex, 1, spanIndex2, spanSize2, z2, DEBUG));
            return;
        }
