...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0627R.styleable.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0627R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0627R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0627R.styleable.LinearLayoutCompat, i, SHOW_DIVIDER_NONE);
        int i2 = obtainStyledAttributes.getInt(C0627R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        i2 = obtainStyledAttributes.getInt(C0627R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i2 >= 0) {
            setGravity(i2);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0627R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0627R.styleable.LinearLayoutCompat_android_weightSum, GroundOverlayOptions.NO_DIMENSION);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0627R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0627R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0627R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        obtainStyledAttributes.recycle();
    }
    ...
    public int getBaseline() {
        ...
        if (baseline != -1) {
            ...
            if (this.mOrientation == VERTICAL) {
                i = this.mGravity & C0861R.styleable.AppCompatTheme_spinnerStyle;
                if (i != 48) {
                    switch (i) {
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int i8 = this.mGravity & C0861R.styleable.AppCompatTheme_spinnerStyle;
        boolean z = this.mBaselineAligned;
        int[] iArr = this.mMaxAscent;
        int[] iArr2 = this.mMaxDescent;
        switch (C0500f.m2143a(i7, aj.m1884g(this))) {
            case VERTICAL /*1*/:
        ...
        while (i9 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                switch (i12 & C0861R.styleable.AppCompatTheme_spinnerStyle) {
                    case C1096c.MapAttrs_ambientEnabled /*16*/:
    ...
    void measureHorizontal(int i, int i2) {
        ...
        Object obj4 = mode == 1073741824 ? VERTICAL : SHOW_DIVIDER_NONE;
        ...
        while (i11 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                int combineMeasuredStates = ViewUtils.combineMeasuredStates(i7, aj.m1886i(virtualChildAt));
                if (z) {
                    i7 = virtualChildAt.getBaseline();
                    if (i7 != -1) {
                        int i15 = ((((layoutParams2.gravity < 0 ? this.mGravity : layoutParams2.gravity) & C0861R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                        iArr[i15] = Math.max(iArr[i15], i7);
                        iArr2[i15] = Math.max(iArr2[i15], i4 - i7);
                    }
                }
                i7 = Math.max(i6, i4);
                obj6 = (obj == null || layoutParams2.height != -1) ? null : VERTICAL;
        ...
        int a = aj.m1852a(Math.max(this.mTotalLength, getSuggestedMinimumWidth()), i, (int) SHOW_DIVIDER_NONE);
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        i9 = ViewUtils.combineMeasuredStates(i15, aj.m1886i(virtualChildAt3) & -16777216);
                        f5 = f3;
                    } else {
                        i12 = i14;
                        i9 = i15;
                    ...
                    if (z) {
                        ...
                        if (i4 != -1) {
                            i3 = ((((layoutParams.gravity < 0 ? this.mGravity : layoutParams.gravity) & C0861R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
        ...
        setMeasuredDimension((-16777216 & i7) | a, aj.m1852a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i7 << 16));
        if (obj2 != null) {
    ...
    void measureVertical(int i, int i2) {
        ...
        while (i13 < virtualChildCount) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (i13 >= i11 || layoutParams.weight <= 0.0f) {
                    ...
                    i7 = Math.max(i7, i5);
                    int combineMeasuredStates = ViewUtils.combineMeasuredStates(i8, aj.m1886i(virtualChildAt2));
        ...
        int a = aj.m1852a(Math.max(this.mTotalLength, getSuggestedMinimumHeight()), i2, (int) SHOW_DIVIDER_NONE);
        i6 = (16777215 & a) - this.mTotalLength;
        int i17;
            ...
            while (i12 < virtualChildCount) {
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f4 = f3;
                        i13 = i15;
                        i15 = ViewUtils.combineMeasuredStates(i16, aj.m1886i(virtualChildAt3) & -256);
                        f5 = f4;
                    } else {
                        f5 = f3;
                        i13 = i15;
        ...
        setMeasuredDimension(aj.m1852a(Math.max(i3 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, i8), a);
        if (obj3 != null) {
    ...
    public void setVerticalGravity(int i) {
        ...
        if ((this.mGravity & C0861R.styleable.AppCompatTheme_spinnerStyle) != i2) {
