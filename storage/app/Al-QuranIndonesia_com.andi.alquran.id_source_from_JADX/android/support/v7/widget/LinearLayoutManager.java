...
public class LinearLayoutManager extends LayoutManager implements ScrollVectorProvider, ViewDropHandler {
    ...
    public void collectInitialPrefetchPositions(int i, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        int i3 = z ? -1 : VERTICAL;
        for (int i4 = HORIZONTAL; i4 < this.mInitialItemPrefetchCount && i2 >= 0 && i2 < i; i4 += VERTICAL) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            ...
            a.m1612b(findFirstVisibleItemPosition());
            a.m1613c(findLastVisibleItemPosition());
        }
    }
