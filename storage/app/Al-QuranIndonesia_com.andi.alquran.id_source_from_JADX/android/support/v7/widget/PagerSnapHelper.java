...
public class PagerSnapHelper extends SnapHelper {
    ...
    class C06771 extends LinearSmoothScroller {
        C06771(Context context) {
            super(context);
        }
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        return !(layoutManager instanceof ScrollVectorProvider) ? null : new C06771(this.mRecyclerView.getContext());
    }
