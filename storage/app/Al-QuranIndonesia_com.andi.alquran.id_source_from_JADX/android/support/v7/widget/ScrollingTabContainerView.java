...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0627R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0627R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    appCompatImageView = new AppCompatTextView(getContext(), null, C0627R.attr.actionBarTabTextStyle);
    ...
    protected class VisibilityAnimListener implements bc {
        ...
        public VisibilityAnimListener withFinalVisibility(ay ayVar, int i) {
            ...
            ScrollingTabContainerView.this.mVisibilityAnim = ayVar;
            return this;
        }
    }
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0627R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0627R.attr.actionBarTabBarStyle);
    ...
    public void animateToTab(int i) {
        ...
        this.mTabSelector = new C06891(childAt);
