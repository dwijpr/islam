...
import android.support.v4.view.C0505h;
import android.support.v4.view.aj;
import android.support.v4.widget.C0564f;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C06934 implements OnFocusChangeListener {
        C06934() {
        }
    ...
    class C06945 implements OnLayoutChangeListener {
        C06945() {
        }
    ...
    class C06956 implements OnGlobalLayoutListener {
        C06956() {
        }
    ...
    class C06967 implements OnClickListener {
        C06967() {
        }
    ...
    class C06978 implements OnKeyListener {
        C06978() {
        }
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            ...
            if (SearchView.this.mSearchSrcTextView.isEmpty() || !C0505h.m2159a(keyEvent) || keyEvent.getAction() != 1 || i != 66) {
                return SearchView.DBG;
            }
    ...
    class C06989 implements OnEditorActionListener {
        C06989() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C06991 implements C0043e<SavedState> {
            C06991() {
            }
        ...
        static {
            CREATOR = C0267d.m910a(new C06991());
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0627R.attr.autoCompleteTextViewStyle);
        }
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            int b = C0209a.m741b(getResources());
            int a = C0209a.m740a(getResources());
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0627R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mShowImeRunnable = new C06901();
        this.mUpdateDrawableStateRunnable = new C06912();
        this.mReleaseCursorRunnable = new C06923();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C06967();
        this.mTextKeyListener = new C06978();
        this.mOnEditorActionListener = new C06989();
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0627R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0627R.styleable.SearchView_layout, C0627R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0627R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0627R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0627R.id.search_plate);
        this.mSubmitArea = findViewById(C0627R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0627R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0627R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0627R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0627R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0627R.id.search_mag_icon);
        aj.m1860a(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_queryBackground));
        aj.m1860a(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0627R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0627R.styleable.SearchView_suggestionRowLayout, C0627R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0627R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C06934());
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0627R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0627R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0627R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0627R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0627R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0627R.styleable.SearchView_android_focusable, true));
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C06956());
    }

    @TargetApi(11)
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C06945());
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0627R.dimen.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0627R.dimen.abc_search_view_preferred_width);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0627R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0627R.dimen.abc_dropdownitem_icon_width) : 0;
    ...
    public C0564f getSuggestionsAdapter() {
    ...
    boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !C0505h.m2159a(keyEvent)) {
            return DBG;
        }
        if (i == 66 || i == 84 || i == 61) {
    ...
    public void setSuggestionsAdapter(C0564f c0564f) {
        this.mSuggestionsAdapter = c0564f;
        this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
    }
