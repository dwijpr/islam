...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C07001 extends OnScrollListener {
        boolean mScrolled;
    ...
    class C07012 extends LinearSmoothScroller {
        C07012(Context context) {
            super(context);
        }
    ...
    public SnapHelper() {
        this.mScrollListener = new C07001();
    }
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        return !(layoutManager instanceof ScrollVectorProvider) ? null : new C07012(this.mRecyclerView.getContext());
    }
