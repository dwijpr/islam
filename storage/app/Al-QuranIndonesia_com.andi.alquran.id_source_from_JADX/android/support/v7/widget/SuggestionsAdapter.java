...
import android.support.v4.widget.C0587t;
...
class SuggestionsAdapter extends C0587t implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0627R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0627R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            checkIconCache = C0173a.getDrawable(this.mProviderContext, parseInt);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0627R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
