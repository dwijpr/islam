...
public class SwitchCompat extends CompoundButton {
    ...
    class C07051 implements AnimationListener {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0627R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0627R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0627R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0627R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0627R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0627R.styleable.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0627R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0627R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0627R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0627R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        colorStateList = obtainStyledAttributes.getColorStateList(C0627R.styleable.SwitchCompat_trackTint);
        if (colorStateList != null) {
            this.mTrackTintList = colorStateList;
            this.mHasTrackTint = true;
        }
        parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0627R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0627R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        this.mPositionAnimator.setAnimationListener(new C07051(z));
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C0242a.m851a(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C0242a.m854a(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C0242a.m851a(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C0242a.m854a(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                C0242a.m850a(background, i2, i3, i, i5);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            C0242a.m848a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            C0242a.m848a(this.mTrackDrawable, f, f2);
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        switch (getGravity() & C0861R.styleable.AppCompatTheme_spinnerStyle) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() < intrinsicHeight) {
            setMeasuredDimension(aj.m1885h(this), intrinsicHeight);
        }
    }
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() != null && aj.m1846C(this) && isShown()) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0627R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0627R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0627R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0627R.styleable.TextAppearance_textAllCaps, false)) {
