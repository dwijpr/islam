...
import android.support.v4.p008a.C0159b;
import android.support.v4.p008a.C0161d;
import android.support.v4.p008a.C0163g;
import android.support.v4.view.C0496e;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C07121 implements Runnable {
        ...
        public void run() {
            if (ItemTouchHelper.this.mSelected != null && ItemTouchHelper.this.scrollIfNecessary()) {
                ...
                aj.m1864a(ItemTouchHelper.this.mRecyclerView, (Runnable) this);
            }
        }
    }

    /* renamed from: android.support.v7.widget.helper.ItemTouchHelper.2 */
    class C07132 implements OnItemTouchListener {
        C07132() {
        }

        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ItemTouchHelper.this.mGestureDetector.m2136a(motionEvent);
    ...
    private class RecoverAnimation implements C0159b {
        ...
        private final C0163g mValueAnimator;
        final ViewHolder mViewHolder;
        float mX;
        float mY;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation.1 */
        class C07191 implements C0161d {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C07191(ItemTouchHelper itemTouchHelper) {
                this.val$this$0 = itemTouchHelper;
            }

            public void onAnimationUpdate(C0163g c0163g) {
                RecoverAnimation.this.setFraction(c0163g.m699c());
            }
        }
        ...
        public RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mTargetX = f3;
            this.mTargetY = f4;
            this.mValueAnimator = C0158a.m689a();
            this.mValueAnimator.m696a(new C07191(ItemTouchHelper.this));
            this.mValueAnimator.m697a(viewHolder.itemView);
            this.mValueAnimator.m695a((C0159b) this);
            setFraction(0.0f);
        }

        public void cancel() {
            this.mValueAnimator.m698b();
        }

        public void onAnimationCancel(C0163g c0163g) {
            setFraction(1.0f);
        }

        public void onAnimationEnd(C0163g c0163g) {
            if (!this.mEnded) {
        ...
        public void onAnimationRepeat(C0163g c0163g) {
        }

        public void onAnimationStart(C0163g c0163g) {
        }

        public void setDuration(long j) {
            this.mValueAnimator.m694a(j);
        }
        ...
        public void start() {
            ...
            this.mValueAnimator.m693a();
        }

        public void update() {
            if (this.mStartDx == this.mTargetX) {
                this.mX = aj.m1889l(this.mViewHolder.itemView);
            } else {
                this.mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.mY = aj.m1890m(this.mViewHolder.itemView);
            } else {
    ...
    class C07143 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C07143(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4, int i3, ViewHolder viewHolder2) {
    ...
    class C07154 implements Runnable {
        ...
        C07154(RecoverAnimation recoverAnimation, int i) {
    ...
    class C07165 implements ChildDrawingOrderCallback {
        C07165() {
        }
        ...
        public int onGetChildDrawingOrder(int i, int i2) {
            ...
            return i2 == i + ItemTouchHelper.ACTIVE_POINTER_ID_NONE ? i3 : i2 >= i3 ? i2 + ItemTouchHelper.UP : i2;
        }
    }
    ...
    public static abstract class Callback {
        ...
        static class C07171 implements Interpolator {
            C07171() {
            }
        ...
        static class C07182 implements Interpolator {
            C07182() {
            }
        ...
        static {
            sDragScrollInterpolator = new C07171();
            sDragViewScrollCapInterpolator = new C07182();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0628R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        final int getAbsoluteMovementFlags(RecyclerView recyclerView, ViewHolder viewHolder) {
            return convertToAbsoluteDirection(getMovementFlags(recyclerView, viewHolder), aj.m1884g(recyclerView));
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C07165();
            }
    ...
    private int checkHorizontalSwipe(ViewHolder viewHolder, int i) {
        ...
        if ((i & 12) != 0) {
            ...
            if (this.mVelocityTracker != null && this.mActivePointerId > ACTIVE_POINTER_ID_NONE) {
                ...
                float a = ah.m1646a(this.mVelocityTracker, this.mActivePointerId);
                float b = ah.m1647b(this.mVelocityTracker, this.mActivePointerId);
                if (a <= 0.0f) {
                    i2 = LEFT;
                }
    ...
    private void getSelectedDxDy(float[] fArr) {
        if ((this.mSelectedFlags & 12) != 0) {
            ...
            fArr[ACTION_STATE_IDLE] = aj.m1889l(this.mSelected.itemView);
        }
        if ((this.mSelectedFlags & 3) != 0) {
            fArr[UP] = (this.mSelectedStartY + this.mDy) - ((float) this.mSelected.itemView.getTop());
        } else {
            fArr[UP] = aj.m1890m(this.mSelected.itemView);
        }
    }
    ...
    private void initGestureDetector() {
        if (this.mGestureDetector == null) {
            this.mGestureDetector = new C0496e(this.mRecyclerView.getContext(), new ItemTouchHelperGestureListener());
        }
    }
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        int convertToAbsoluteDirection = (this.mCallback.convertToAbsoluteDirection(movementFlags, aj.m1884g(this.mRecyclerView)) & ACTION_MODE_SWIPE_MASK) >> RIGHT;
        ...
        if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
            ...
            if (movementFlags > 0) {
                return (i & movementFlags) == 0 ? Callback.convertToRelativeDirection(movementFlags, aj.m1884g(this.mRecyclerView)) : movementFlags;
            } else {
            ...
            movementFlags = checkHorizontalSwipe(viewHolder, convertToAbsoluteDirection);
            return movementFlags > 0 ? (i & movementFlags) == 0 ? Callback.convertToRelativeDirection(movementFlags, aj.m1884g(this.mRecyclerView)) : movementFlags : ACTION_STATE_IDLE;
        }
    }
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0628R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0628R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    void postDispatchSwipe(RecoverAnimation recoverAnimation, int i) {
        this.mRecyclerView.post(new C07154(recoverAnimation, i));
    }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c07143 = new C07143(viewHolder2, i4, i2, f2, f3, f, signum, swipeIfNecessary, viewHolder2);
                    c07143.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c07143);
                    c07143.start();
                    obj = UP;
                } else {
