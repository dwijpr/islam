...
/* renamed from: com.andi.alquran.i.l */
public class C0935l extends C0934k {
    private C0914e f1884c;
    private C0911a f1885d;

    private C0935l(Handler handler, C0914e c0914e) {
        super(handler);
        this.f1884c = c0914e;
        this.f1885d = new C0911a(this.f1884c.m3157f(), c0914e.m3158g(), Integer.valueOf(0));
    }

    public static C0935l m3258a(Handler handler, C0914e c0914e) {
        return new C0935l(handler, c0914e);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m3259a(com.andi.alquran.p028g.p029a.C0914e r16) {
        /*
        r15 = this;
        r0 = 0;
        r8 = r15.m3264c();	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x01d5, IOException -> 0x01d0, Exception -> 0x01cb, all -> 0x01ba }
        r0 = r15.m3265d();	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x01d5, IOException -> 0x01d0, Exception -> 0x01cb, all -> 0x01ba }
        ...
        r2 = r15.f1885d;	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x00b3, IOException -> 0x0154, Exception -> 0x018d }
    ...
    L_0x0058:
        ...
        r1 = r15;
        r1.m3261a(r2, r3, r4, r6);	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x00b3, IOException -> 0x0154, Exception -> 0x018d }
    L_0x0060:
        r1 = 0;
    ...
    L_0x0085:
        ...
        r15.m3260a(r1);	 Catch:{ all -> 0x01c4 }
    ...
    L_0x0099:
        return;
    L_0x009a:
        r1 = r15.f1885d;	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x00b3, IOException -> 0x0154, Exception -> 0x018d }
    ...
    L_0x00bd:
        r0 = "";
    L_0x00bf:
        r15.m3262b(r0);	 Catch:{ all -> 0x01c9 }
    ...
    L_0x0140:
        r2 = r16.m3157f();	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x00b3, IOException -> 0x0154, Exception -> 0x018d }
        r1 = r15;
        r1.m3263b(r2, r3, r4, r6);	 Catch:{ SocketTimeoutException -> 0x0085, InterruptedException -> 0x00b3, IOException -> 0x0154, Exception -> 0x018d }
        if (r0 == 0) goto L_0x0099;
    L_0x014a:
        r0.disconnect();
        goto L_0x0099;
    ...
    L_0x017e:
        r15.m3260a(r0);	 Catch:{ all -> 0x01c9 }
        if (r1 == 0) goto L_0x0099;
    L_0x0183:
        r1.disconnect();
        goto L_0x0099;
    ...
    L_0x01d5:
        ...
        goto L_0x00b7;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.andi.alquran.i.l.a(com.andi.alquran.g.a.e):void");
    }

    private void m3260a(String str) {
        m3256a(this.a.obtainMessage(-1, new C0913c(this.f1885d.m3157f(), this.f1885d.m3158g(), str)));
    }

    private void m3261a(String str, int i, long j, long j2) {
        this.f1885d.m3161a(str, Integer.valueOf(i), j, j2);
        m3256a(this.a.obtainMessage(1, this.f1885d));
    }

    private void m3262b(String str) {
        m3256a(this.a.obtainMessage(-1, new C0913c(this.f1885d.m3157f(), this.f1885d.m3158g(), str, true)));
    }

    private void m3263b(String str, int i, long j, long j2) {
        this.f1885d.m3161a(str, Integer.valueOf(i), j, j2);
        m3256a(this.a.obtainMessage(2, this.f1885d));
    }

    private RandomAccessFile m3264c() {
        File file = new File(this.f1885d.m3164d());
        if (file.getParentFile().isDirectory() || file.getParentFile().mkdirs()) {
            RandomAccessFile randomAccessFile = new RandomAccessFile(file, "rw");
            long length = new File(this.f1885d.m3164d()).exists() ? new File(this.f1885d.m3164d()).length() : 0;
            if (length != 0) {
    ...
    private HttpURLConnection m3265d() {
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(this.f1884c.m3187a()).openConnection();
    ...
    protected void m3266a() {
        File file = new File(this.f1885d.m3165e());
        if (file.exists()) {
            long length = file.length();
            m3261a(this.f1884c.m3157f(), 100, length, length);
            new C0953l(this.f1885d.m3165e(), App.m2887l()).m3325a();
            file = new File(this.f1885d.m3165e());
            if (file.exists()) {
                try {
                    file.delete();
                } catch (Exception e) {
            ...
            file = new File(App.m2887l() + this.f1884c.m3157f());
            if (file.exists() && file.isDirectory()) {
                C0723a.m2549a(file);
            }
            m3263b(this.f1884c.m3157f(), 100, length, length);
            return;
        }
        m3259a(this.f1884c);
    }
