...
public final class AdSize {
    ...
    private final com.google.android.gms.ads.AdSize f2240a;

    static {
        SMART_BANNER = new AdSize(FULL_WIDTH, AUTO_HEIGHT, "mb");
        BANNER = new AdSize(320, PORTRAIT_AD_HEIGHT, "mb");
        IAB_MRECT = new AdSize(300, Callback.DEFAULT_SWIPE_ANIMATION_DURATION, "as");
    ...
    public boolean equals(Object obj) {
        ...
        return this.f2240a.equals(((AdSize) obj).f2240a);
    }
    ...
    public int getHeightInPixels(Context context) {
        return this.f2240a.getHeightInPixels(context);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.f2240a.getWidthInPixels(context);
    }
    ...
    public boolean isAutoHeight() {
        return this.f2240a.isAutoHeight();
    }
    ...
    public boolean isFullWidth() {
        return this.f2240a.isFullWidth();
    }
