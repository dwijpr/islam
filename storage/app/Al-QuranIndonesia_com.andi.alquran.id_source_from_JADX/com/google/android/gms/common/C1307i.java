...
import com.google.android.gms.common.internal.C1299v;
import com.google.android.gms.common.internal.C1299v.C1300a;
import com.google.android.gms.common.internal.C1314c;
import com.google.android.gms.common.util.C1383i;
...
class C1307i {
    private static final Object f3040a;
    private static Context f3041b;

    /* renamed from: com.google.android.gms.common.i.a */
    static abstract class C1301a extends C1300a {
        private int f3035a;

        protected C1301a(byte[] bArr) {
            boolean z = false;
            if (bArr.length != 25) {
                int length = bArr.length;
                String valueOf = String.valueOf(C1383i.m4950a(bArr, 0, bArr.length, false));
                ...
                C1314c.m4633b(z, "cert hash data has incorrect length. length=" + bArr.length);
            }
            this.f3035a = Arrays.hashCode(bArr);
        }

        protected static byte[] m4604a(String str) {
            try {
        ...
        public C1108c m4605a() {
            return C1111d.m3896a(m4607c());
        }
        ...
        abstract byte[] m4607c();

        public boolean equals(Object obj) {
            if (obj == null || !(obj instanceof C1299v)) {
                return false;
            }
            try {
                C1299v c1299v = (C1299v) obj;
                if (c1299v.m4603b() != hashCode()) {
                    return false;
                }
                C1108c a = c1299v.m4602a();
                if (a == null) {
                    return false;
                }
                return Arrays.equals(m4607c(), (byte[]) C1111d.m3897a(a));
    ...
    static class C1302b extends C1301a {
    ...
    /* renamed from: com.google.android.gms.common.i.c */
    static abstract class C1303c extends C1301a {
        private static final WeakReference<byte[]> f3037b;
        private WeakReference<byte[]> f3038a;

        static {
            f3037b = new WeakReference(null);
        }
    ...
    static synchronized void m4613a(Context context) {
        synchronized (C1307i.class) {
            if (f3041b != null) {
                Log.w("GoogleCertificates", "GoogleCertificates has been initialized already");
            } else if (context != null) {
                f3041b = context.getApplicationContext();
            }
        }
    }
}
