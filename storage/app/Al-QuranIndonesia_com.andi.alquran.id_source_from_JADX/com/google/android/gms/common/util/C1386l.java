...
public class C1386l {
    ...
    public static int m4958a(byte[] r6, int r7, int r8, int r9) {
        /*
    ...
    L_0x006b:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.l.a(byte[], int, int, int):int");
    }
}
