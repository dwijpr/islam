...
public final class gp {
    private final AdSize[] f4169a;
    private final String f4170b;

    public gp(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1096c.AdsAttrs);
        String string = obtainAttributes.getString(C1096c.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C1096c.AdsAttrs_adSizes);
        Object obj2 = !TextUtils.isEmpty(string) ? 1 : null;
        if (TextUtils.isEmpty(string2)) {
            obj = null;
        }
        if (obj2 != null && r1 == null) {
            this.f4169a = m6350a(string);
        } else if (obj2 == null && r1 != null) {
            this.f4169a = m6350a(string2);
        } else if (obj2 != null) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        this.f4170b = obtainAttributes.getString(C1096c.AdsAttrs_adUnitId);
        if (TextUtils.isEmpty(this.f4170b)) {
            throw new IllegalArgumentException("Required XML attribute \"adUnitId\" was missing.");
        }
    }

    private static AdSize[] m6350a(String str) {
    ...
    public AdSize[] m6352a(boolean z) {
        if (z || this.f4169a.length == 1) {
            return this.f4169a;
        }
