...
public interface he extends IInterface {
    ...
    public static abstract class C1186a extends Binder implements he {

        /* renamed from: com.google.android.gms.internal.he.a.a */
        private static class C1620a implements he {
            ...
            public void setAppMuted(boolean z) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4232a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzb(C1108c c1108c, String str) {
                ...
                try {
                    ...
                    this.f4232a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzy(String str) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    obtain.writeString(str);
                    this.f4232a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static he zzu(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof he)) ? new C1620a(iBinder) : (he) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case C1096c.MapAttrs_cameraZoom /*5*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    zzb(C1110a.m3895a(parcel.readStrongBinder()), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zzb(C1108c c1108c, String str);
