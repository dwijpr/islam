...
public class vu {
    public static long m9565a(String str) {
        try {
    ...
    public static C1516a m9566a(kj kjVar) {
        Object obj;
        long j;
        Object obj2;
        long currentTimeMillis = System.currentTimeMillis();
        Map map = kjVar.f4634c;
        long j2 = 0;
        long j3 = 0;
        long j4 = 0;
        ...
        long a = str != null ? m9565a(str) : 0;
        str = (String) map.get("Last-Modified");
        long a2 = str != null ? m9565a(str) : 0;
    ...
    public static String m9567a(Map<String, String> map) {
        return m9568a(map, "ISO-8859-1");
    }

    public static String m9568a(Map<String, String> map, String str) {
