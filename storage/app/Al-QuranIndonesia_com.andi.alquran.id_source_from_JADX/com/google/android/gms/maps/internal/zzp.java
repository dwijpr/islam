...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C2171a implements zzp {
            private IBinder f6891a;
            ...
            public void zzJ(C1108c c1108c) {
                ...
                try {
                    ...
                    this.f6891a.transact(1, obtain, obtain2, 0);
            ...
            public void zze(Location location) {
                ...
                try {
                    ...
                    this.f6891a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzp zzdK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzp)) ? new C2171a(iBinder) : (zzp) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case GoogleMap.MAP_TYPE_NORMAL /*1*/:
                    ...
                    zzJ(C1110a.m3895a(parcel.readStrongBinder()));
    ...
    void zzJ(C1108c c1108c);

    void zze(Location location);
}
