...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C2173a implements zzr {
            private IBinder f6893a;

            C2173a(IBinder iBinder) {
                this.f6893a = iBinder;
            }
            ...
            public void onMapLoaded() {
                ...
                try {
                    ...
                    this.f6893a.transact(1, obtain, obtain2, 0);
        ...
        public static zzr zzdM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C2173a(iBinder) : (zzr) queryLocalInterface;
        }
