...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C2175a implements zzt {
            private IBinder f6895a;

            C2175a(IBinder iBinder) {
                this.f6895a = iBinder;
            }
            ...
            public void zza(IGoogleMapDelegate iGoogleMapDelegate) {
                ...
                try {
                    ...
                    this.f6895a.transact(1, obtain, obtain2, 0);
        ...
        public static zzt zzdO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C2175a(iBinder) : (zzt) queryLocalInterface;
        }
