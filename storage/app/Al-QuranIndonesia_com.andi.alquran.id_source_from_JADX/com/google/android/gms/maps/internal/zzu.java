...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C2176a implements zzu {
            private IBinder f6896a;

            C2176a(IBinder iBinder) {
                this.f6896a = iBinder;
            }
            ...
            public boolean zza(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    ...
                    this.f6896a.transact(1, obtain, obtain2, 0);
        ...
        public static zzu zzdP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C2176a(iBinder) : (zzu) queryLocalInterface;
        }
