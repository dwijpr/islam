...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        /* renamed from: com.google.android.gms.maps.internal.zzv.zza.a */
        private static class C2177a implements zzv {
            private IBinder f6897a;

            C2177a(IBinder iBinder) {
                this.f6897a = iBinder;
            }
            ...
            public void zzb(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    ...
                    this.f6897a.transact(1, obtain, obtain2, 0);
            ...
            public void zzc(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    obtain.writeStrongBinder(com_google_android_gms_maps_model_internal_zzf != null ? com_google_android_gms_maps_model_internal_zzf.asBinder() : null);
                    this.f6897a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzd(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    obtain.writeStrongBinder(com_google_android_gms_maps_model_internal_zzf != null ? com_google_android_gms_maps_model_internal_zzf.asBinder() : null);
                    this.f6897a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzv zzdQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C2177a(iBinder) : (zzv) queryLocalInterface;
        }
