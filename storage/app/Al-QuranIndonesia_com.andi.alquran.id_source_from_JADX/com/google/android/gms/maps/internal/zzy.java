...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        /* renamed from: com.google.android.gms.maps.internal.zzy.zza.a */
        private static class C2180a implements zzy {
            private IBinder f6900a;
            ...
            public void zza(PointOfInterest pointOfInterest) {
                ...
                try {
                    ...
                    this.f6900a.transact(1, obtain, obtain2, 0);
        ...
        public static zzy zzdT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C2180a(iBinder) : (zzy) queryLocalInterface;
        }
